...
const CONDITION_GUIDES: ConditionGuide[] = [
  ...
  },
  {
    code: 'like_new',
    label: 'Like New',
    description: 'Excellent condition. May have been worn once or twice, but looks brand new. No visible flaws.',
    keywords: ['like new', 'excellent', 'pristine', 'mint', 'barely used'],
  },
  {
    code: 'good',
    label: 'Good',
    description: 'Gently used with minor signs of wear. May have slight pilling, fading, or light marks. Still in great shape.',
    keywords: ['good', 'gently used', 'used', 'normal wear'],
  },
  {
    code: 'fair',
    label: 'Fair',
    description: 'More noticeable wear. May have stains, holes, missing parts, or significant fading. Still functional.',
    keywords: ['fair', 'well used', 'worn', 'stained', 'faded'],
  },
  {
    code: 'worn',
    label: 'Worn',
    description: 'Heavy wear and tear. Multiple issues like stains, holes, broken parts. May need repairs.',
...
export function matchColorToPalette(colorName: string): string | null {
  ...
  // Try partial match
  const partialMatch = COLOR_PALETTE.find(c => 
