...
with_node \
  ...
  --target "/Users/sameralzubaidi/Desktop/kids_marketplace_app/p2p-kids-marketplace/ios/Pods/Target Support Files/Pods-p2pkidsmarketplace/ExpoModulesProvider.swift" \
  --entitlement "/Users/sameralzubaidi/Desktop/kids_marketplace_app/p2p-kids-marketplace/ios/p2pkidsmarketplace/p2pkidsmarketplace.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-location" "expo-notifications" "expo-updates"
