-- =====================================================
-- Migration: 307_liability_disclaimer_tracking.sql
-- Task: SAFETY-012 - Transaction Disclaimer Tracking
-- Description: Add disclaimer acknowledgment tracking to trades table
-- =====================================================
...
-- 1. Verify columns added to trades
...
-- SELECT indexname FROM pg_indexes WHERE tablename = 'trades' AND indexname LIKE '%disclaimer%';

-- 3. Verify RPC functions exist
-- SELECT proname FROM pg_proc WHERE proname IN ('create_trade_with_disclaimer_v2', 'acknowledge_trade_disclaimer');

-- 4. Test get_current_policy for liability_disclaimer
