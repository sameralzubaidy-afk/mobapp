...
BEGIN
  ...
  -- Check if points_transactions table exists (Module 09 dependency)
  IF NOT EXISTS (
...
-- =============================================================================
-- 4. CREATE TRIGGER: trigger_process_referral_bonus_on_trade (CONDITIONAL)
-- =============================================================================
-- Only create if trades table exists (Module 06 dependency)
