-- Migration: Fix admin_get_user_detail DOB column mismatch
-- Mode: Idempotent rerunnable migration (Mode B)
-- Issue: profiles table uses "dob" column, not "date_of_birth"
