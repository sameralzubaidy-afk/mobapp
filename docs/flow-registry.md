...
### DEV-TASK-94 (2026-09-03) — Reopen DT92 item 2 (initial billing_history row missing) + grace-period config fix + SubscriptionExpired UX + SUB-guide doc-sync (FLOW-12, FLOW-18)
