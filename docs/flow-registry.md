...
- **MODULE-15.1.2-TRADEFLOWV2-FULL (2026-05-28):** Complete Trade Flow V2 — all 24 tasks TFV2-001 through TFV2-022 + TFV2-023 + Addenda A–E
  ...
  - Scope:
    ...
    - **TFV2-015** Seller ignoring offers prompt: nudge shown when `listing_offer_stats.unanswered_offer_count >= threshold` (column is `unanswered_offer_count` — the `consecutive_unanswered_offers_count` name was superseded by the 2026-06 schema-drift fix; DT-19 reconciled this doc to the real column)
