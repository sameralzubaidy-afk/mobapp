# ⚠️ DEPRECATED — Superseded by `cross-checked-and-consolidated/MODULE-15.1.2-TradeFlowV2-MANUAL-TESTING.md`
...
>
> **Canonical:** `cross-checked-and-consolidated/MODULE-15.1.2-TradeFlowV2-MANUAL-TESTING.md` (repointed 2026-08-13; `misc/` archived to `archive/misc/` — historical reference only)
>
