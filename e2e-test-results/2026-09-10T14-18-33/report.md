# TradeFlowV2 Automated Run — 2026-09-10T14:22:38.111Z
...
- Duration: 114.2s · Attempts: 2
```

Waiting for flows to complete...
[Failed] module-15.1.2-flow-08-trade-v2-components (1m 44s) (Couldn't hide the keyboard. This can happen if the app uses a custom input or doesn't expose a standard dismiss action.)
...
- Average per unit: 114.2s
- Slowest passing unit: N/A
- Slowest failing unit: 1.9m 54s
