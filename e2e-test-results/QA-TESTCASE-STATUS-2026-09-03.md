...
| **ADM** | `MODULE-ADMIN-PORTAL-MANUAL-TESTING.md` | 160 | 135 | 20 | 1 | 0 | 1 | 0 | 0 | 0 | 0 | **3** |
...
**Guide file:** `cross-checked-and-consolidated/MODULE-ADMIN-PORTAL-MANUAL-TESTING.md` · **Cases:** 160 (canonical) · **PASS** 135 · **PARTIAL** 20 · **OPEN (FAIL)** 1 · **DOC-DRIFT** 0 · **SKIPPED** 1 · **Remaining (NEVER RUN)** 3 · (+8 supplementary sub-case rows in Completed — see roll-up note)
...
| ADM-TC-C09 | Request Edits | ✅ PASS | PASS | 2026-09-05 | `qa-task31m-r5-mobile-owed-2026-09-05` | disposable 7a045732 request-edits → needs_edits + note stored (QA30); mobile leg cross-referenced R5: seller ListingSafetyReview needs_edits branch is the same screen as C10's captured REJECTED branch (source-verified "This listing needs edits…" + "Admin's Edit Request"); no needs_edits item staged to re-drive nav |
...
| ADM-TC-E02 | Add / edit node | ✅ PASS | PASS | 2026-09-04 | `qa-task31-adm-near-total-2026-09-04` | disposable aeffbaa5 created (zip autolookup) + edited (DB). Mobile leg = a fresh user resolving to the new node's ZIP (signup-fixture, R41 class) — not driven R5 |
...
| ADM-TC-E05 | ZIP waitlist queue + filter | ✅ PASS | PASS | 2026-09-04 | `qa-task31-adm-near-total-2026-09-04` | metrics 14/14/0/0 DB-exact; search ZIP filters; Joined empty state exact (QA31). Mobile waitlist→Joined transition needs a fresh-signup fixture (R41 class) — not driven R5 |
