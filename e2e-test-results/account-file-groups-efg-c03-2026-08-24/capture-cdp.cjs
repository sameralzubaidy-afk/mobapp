...
// CommonJS (.cjs) — streams Runtime.consoleAPICalled / Log.entryAdded / Runtime.exceptionThrown
// from the Metro Hermes inspector and writes captured lines to a file in the run's evidence folder.
'use strict';
const fs = require('fs');
