...
| TRD-TC-E08 | Report an Issue — reason selected (non-Other) | 1 | PARTIAL | 2026-08-29 | `qa-task6-e-reverify-2026-08-29` | 🟡 PARTIAL (non-Other → green selected radio + no textarea + Submit enabled 88.6% ✅; **deselect-on-retap NOT implemented** — IssueReportModal onPress is a plain set, guide assertion not met) |
...
| TRD-TC-E10 | Report an Issue — submitting + success/error | 1 | PASS | 2026-08-29 | `qa-task6-e-reverify-2026-08-29` | ✅ PASS (Submit (non-Other) → modal closes → amber "Dispute in progress" banner; DB: `dispute_status=reported` reason `no_show`, 1 `trade_disputed` event, 1 seller `trade_dispute_opened` notif; Report Problem hidden + I Got It disabled post-submit) |
